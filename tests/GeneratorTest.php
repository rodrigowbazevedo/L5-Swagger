...
class GeneratorTest extends TestCase
{
    ...
    public function canGenerateApiJsonFile(): void
    {
        ...
        $this->get(route('l5-swagger.default.docs', ['jsonFile' => config('l5-swagger.documentations.default.paths.docs_yaml')]))
            ->assertSee('L5 Swagger')
            ->assertSee('my-default-host.com')
            ->assertStatus(200);
    }
    ...
    public function canSetValidatorUrl(): void
    {
        ...
        $this->get(route('l5-swagger.default.api', ['jsonFile' => config('l5-swagger.documentations.default.paths.docs_yaml')]))
            ->assertSee('validator-url.dev')
            ->assertStatus(200);
