...
class TestCase extends OrchestraTestCase
{
    ...
    {
        if (! is_dir(config('l5-swagger.documentations.default.paths.docs'))) {
            mkdir(config('l5-swagger.documentations.default.paths.docs'));
        }

        return config('l5-swagger.documentations.default.paths.docs').'/'.config('l5-swagger.documentations.default.paths.docs_json');
    }
    ...
    protected function yamlDocsFile(): string
    {
        ...
        return config('l5-swagger.documentations.default.paths.docs').'/'.config('l5-swagger.documentations.default.paths.docs_yaml');
    }
